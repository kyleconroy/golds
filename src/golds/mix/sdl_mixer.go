...
// #cgo CFLAGS: -I../../../vendor/sdl2/include/ -I../../../vendor/sdl2_mixer
// #cgo darwin LDFLAGS: lib/darwin/amd64/libsdl2.a lib/darwin/amd64/libsdl2_mixer.a -liconv
// #cgo darwin LDFLAGS: -framework Cocoa -framework Carbon -framework AudioUnit -framework CoreAudio -framework ForceFeedback -framework IOKit -framework AudioToolbox
// #include "SDL_mixer.h"
import "C"
import "unsafe"
import "golds/sdl"
